...
import { callSessions, people, runs, tokenSpend } from '../../db/schema'
...
export default async function ObservatoryPage() {
  ...
  const data = await app.withTenantContext(tenantId, async () => {
    ...
    return { runRows, spendRows, inboundCallRows }
  })

  // Faces on the run list are the head crop of each agent's one figure.
