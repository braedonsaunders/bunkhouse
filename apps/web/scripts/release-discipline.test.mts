...
test('the registry-gap dependency is content-addressed', async () => {
  const artifact = await readFile(new URL('vendor/appkit/braedonsaunders-appkit-sync-1.1.0-05f281b688b5.tgz', repo))
  assert.equal(createHash('sha256').update(artifact).digest('hex'), 'a382a449fca82abe3f987ccdb9e956e03ab631b25d6d03499d928c08457d8201')
})
